import { siJira, siMailchimp, siSap, siZendesk, type SimpleIcon } from "simple-icons";
    ...
    return (
      ...
      >
        <svg viewBox="0 0 38 27" className="h-5 w-7" aria-hidden="true">
          <path
            d="M15 3.4a8 8 0 0 1 11.9 3.4 6.5 6.5 0 0 1 8.8 6.1 6.5 6.5 0 0 1-6.5 6.5H9.1a7.1 7.1 0 1 1 1.8-14A8.1 8.1 0 0 1 15 3.4Z"
            fill="#0D9DDA"
          />
          <text
            x="19"
