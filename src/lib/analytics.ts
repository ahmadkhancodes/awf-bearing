...
export interface DemoSource {
  ...
  health: SourceHealth;
  note: string;
  brand: "sap" | "salesforce" | "mailchimp" | "zendesk" | "workday" | "jira";
}
...
export const SOURCES: DemoSource[] = [
  ...
  },
  {
    id: "src-marketing",
    name: "Mailchimp",
    system: "Marketing and customer communications",
    category: "Revenue & customers",
    lastSync: "Today, 05:25",
    records: 18420,
    scope: "Read-only · audiences, campaigns, engagement",
    health: "healthy",
    note: "Simulated connection · demo data",
    brand: "mailchimp",
  },
  {
    id: "src-support",
    name: "Zendesk",
    system: "Support and customer health",
    category: "Support",
  ...
  },
  {
    id: "src-delivery",
    name: "Jira",
    system: "Delivery and project operations",
    category: "Service delivery",
    lastSync: "Today, 05:40",
    records: 91744,
    scope: "Read-only · projects, issues, milestones",
    health: "healthy",
    note: "Simulated connection · demo data",
    brand: "jira",
  },
